...
class ArtworkModelTests(TestCase):
    ...
    def test_artwork_creation(self):
        ...
        """
        artwork = Artwork.objects.create(name="Test Artwork", description="Test description", price=10)
...
class ArtworkViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.artwork = Artwork.objects.create(name="Test Artwork", description="Test description", price=10)
    ...
    def test_view_artwork_detail(self):
        ...
        response = self.client.get(reverse('artwork_detail', args=[str(self.artwork.id)]))
