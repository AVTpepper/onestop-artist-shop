...
class OrderLineItem(models.Model):
    ...
    artwork_length = models.DecimalField(max_digits=6, decimal_places=2, null=True, blank=True)
    artwork_width = models.DecimalField(max_digits=6, decimal_places=2, null=True, blank=True)
    artwork_height = models.DecimalField(max_digits=6, decimal_places=2, null=True, blank=True)
